<aside class="asideLeft uk-background-oxfordBlue uk-overflow-hidden">
    ...
    <ul class="uk-nav-default uk-nav-parent-icon asideLeft__nav" uk-nav>
        ...
        <li class="asideLeft__li uk-parent">
            ...
            <ul class="uk-nav-sub asideLeft__sub">
                <li style="width: 90%;margin-left: 5%;"><a href="{{url('nhanvien/trung-tam-ho-tro/newsletter')}}">Newsletter</a></li>
                <li style="width: 90%;margin-left: 5%;"><a href="{{url('nhanvien/trung-tam-ho-tro/tu-van-khach-hang')}}">Tư vấn khách hàng</a></li>
            </ul>
        </li>
    </ul>
</aside>
