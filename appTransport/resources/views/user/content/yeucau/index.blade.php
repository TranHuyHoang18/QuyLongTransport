                                ...
                                @foreach($yeucaus as $yeucau)
                                    ...
                                    <li style="padding-top: 2%;padding-bottom: 2%" >
                                        ...
                                        <div class="uk-margin-medium uk-text-right" style="padding-right: 3%;">
                                            @if($yeucau->trangthai==0)
                                                <a href="{{url('nhanvien/yeu-cau/tiep-nhan/'.$yeucau->ma_yc)}}"> <button style="background: #FFAA00;padding: 10px 10px 10px 10px;color: white;font-size: 16px;border: none;border-radius: 10px 10px 10px 10px"> Tiếp nhận đơn hàng</button></a>
                                            @endif
                                            <a href="{{url('nhanvien/yeu-cau/delete/'.$yeucau->ma_yc)}}" onclick="return confirm('Bạn chắc chắn muốn xóa ?')" style="margin-left: 10px"> <button style="background: #b8230f;padding: 10px 10px 10px 10px;color: white;font-size: 16px;border: none;border-radius: 10px 10px 10px 10px"> Xóa yêu cầu</button></a>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
