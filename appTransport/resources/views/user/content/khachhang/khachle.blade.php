    ...
    <div id="new-category" style="display: none">
        <div class="uk-card uk-card-default">
            <div class="uk-card-body uk-padding-small uk-box-shadow" style="padding-top: 2%;padding-bottom: 5%">
                <form action="{{url('nhanvien/khach-hang/khach-le/add/')}}" method="post" class="uk-grid-small uk-grid" uk-grid>
                    @csrf
                    ...
                    @foreach($khachles as $khachle)
                       ...
                       <tr>
                            ...
                            <td style="border-right: none">
                                ...
                                <a href="{{url('nhanvien/khach-hang/khach-le/delete/'.$khachle->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa ? ')"><button class="btn btn-danger">Xóa</button></a>
                            </td>
                       </tr>
                    @endforeach
                    </tbody>
