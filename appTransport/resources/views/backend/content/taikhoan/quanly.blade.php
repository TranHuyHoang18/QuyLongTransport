...
@section('content')
    <div class="row" style="font-family: 'Segoe UI';background: #E8E8E8;width: 100%">
        <div class="row">
            <h3 style="color:#4D4D4D;margin-left: 5%">DANH SÁCH QUẢN LÝ (chỉ xem)</h3>
        </div>
        ...
        <div id="formnhanvien" class="row"  style="width: 90%;margin-left: 3%;background: #E9E9E9;padding-bottom: 5%;display: none">
            <form action="{{url('admin/tai-khoan/quan-ly/them')}}" method="post" style="margin-top: 5%;border-radius: 10px 0px 10px 0px;border: 1px solid #707070;padding: 3% 3% 3% 3%;background: white">
                @csrf
                <div class="row">
                    <div class="col-sm-3">
                        <h4>Họ và tên</h4>
               ...
               <?php  $i=0; ?>
                @foreach($nhanviens as $nhanvien)
                    ...
                    @endif
                            ...
                            <td><a href="{{url('admin/tai-khoan/quan-ly/doi-mat-khau/'.$nhanvien->id)}}"> <button class="btn btn-success">Reset</button></a></td>
