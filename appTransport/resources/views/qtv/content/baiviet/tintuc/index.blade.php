...
@section('content')
    <div id="new-post" style="display: none">
        <div class="uk-card uk-card-default" style="background: none; box-shadow: none">
            <div class="uk-card-body uk-padding-small uk-box-shadow" style="padding-top: 2%;padding-bottom: 5%">
                <form action="{{url('qtv/bai-viet/tin-tuc/add')}}" method="post" class="uk-grid-small uk-grid" uk-grid>
                    @csrf
                    ...
                    <div id="add-detail" style="width: 100%; margin-left: 0px;margin-top: 0px; padding-left: 0px">
                        ...
                        <div class="uk-card-default" uk-grid style="width: 100%; margin-left: 0px;margin-top: 0px; padding-top: 20px" >
                            <div class="uk-width-1-1@s uk-width-1-4@m">
                                <div class="uk-text-left uk-text-large">
                                    <label class="uk-form-label uk-text-large" style="font-size: large"> Vị trí</label>
                                </div>
                            </div>
                            <div class="uk-width-1-1@s uk-width-3-4@m"  style=" margin-top: 0px">
                                <div class="uk-form-controls" style="margin-left: 0px; width: 90%" uk-form-custom="target: > * > span:first-child" >
                                    <select name="vitri" style="float: left;border-radius: 5px 5px 5px 5px;border: 1px solid #707070;background: #F5F5F5; min-height: 40px">
                                        <option value="1">News Trang Chủ</option>
                    ...
                    @foreach($pages as $page)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('qtv/bai-viet/tin-tuc/delete/'.$page->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa ? ')"><button class="btn btn-danger">Xóa</button></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
    ...
    @foreach($pages as $page)
        <div class="formedit" id="{{'formedit-'.$page->id}}" style="display: none">
            <div class="uk-card uk-card-default" style="background: none; box-shadow: none">
                <div class="uk-card-body uk-padding-small uk-box-shadow" style="padding-top: 2%;padding-bottom: 5%">
                    <form action="{{url('qtv/bai-viet/tin-tuc/edit/'.$page->id)}}" method="post" class="uk-grid-small uk-grid" uk-grid>
                        @csrf
                        ...
                        <div class="uk-card-default" uk-grid style="width: 100%; margin-left: 0px;margin-top: 0px; padding-top: 20px" >
                            ...
                            <div class="uk-width-1-1@s uk-width-3-4@m"  style=" margin-top: 0px">
                                <div class="uk-form-controls" style="margin-left: 0px; width: 90%" uk-form-custom="target: > * > span:first-child" >
                                    <select name="vitri" style="float: left;border-radius: 5px 5px 5px 5px;border: 1px solid #707070;background: #F5F5F5; min-height: 40px">
                                        @if($page->vitri==1)
                                            <option value="1" selected>News Trang Chủ</option>
                                            <option value="0">Mặc định</option>
                                        @else
                                            <option value="1">News Trang Chủ</option>
                        ...
                        <div class="uk-card-default" uk-grid style="width: 100%; margin-left: 0px;margin-top: 0px; padding-top: 20px;" >
                            <div class="uk-width-1-1@s uk-width-1-1@m">
                                <div class="uk-text-left uk-text-large">
                                    <label class="uk-form-label uk-text-large" style="font-size: large">Giới thiệu ngắn</label>
                                </div>
                            </div>
                            <div class="uk-width-1-1@s uk-width-1-1@m" style=" margin-top: 0px">
                                <div class="uk-form-controls" style="margin-left: 0px;">
                                    <textarea type="text" name="intro" class="form-control mytinymce" id="desc"
                                              required="" style="width: 93%;border-radius: 5px 5px 5px 5px;border: 1px solid #707070;background: #F5F5F5"><?php echo $page->intro ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="uk-card-default" uk-grid style="width: 100%; margin-left: 0px;margin-top: 0px; padding-top: 20px;" >
