...
@section('content')
    <div id="new-post" style="display: none">
        <div class="uk-card uk-card-default" style="background: none; box-shadow: none">
            <div class="uk-card-body uk-padding-small uk-box-shadow" style="padding-top: 2%;padding-bottom: 5%">
                <form action="{{url('qtv/bai-viet/gia-cuoc/add')}}" method="post" class="uk-grid-small uk-grid" uk-grid>
                    @csrf
                    ...
                    @foreach($pages as $page)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('qtv/bai-viet/gia-cuoc/delete/'.$page->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa ? ')"><button class="btn btn-danger">Xóa</button></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
    ...
    @foreach($pages as $page)
        <div class="formedit" id="{{'formedit-'.$page->id}}" style="display: none">
            <div class="uk-card uk-card-default" style="background: none; box-shadow: none">
                <div class="uk-card-body uk-padding-small uk-box-shadow" style="padding-top: 2%;padding-bottom: 5%">
                    <form action="{{url('qtv/bai-viet/gia-cuoc/edit/'.$page->id)}}" method="post" class="uk-grid-small uk-grid" uk-grid>
                        @csrf
