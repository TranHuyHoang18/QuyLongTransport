        ...
        <table class="table table-bordered">
            ...
            @foreach($buucucs as $buucuc)
                <tr>
                    ...
                    <td>
                        <a href="{{url('qtv/buu-cuc/edit/'.$buucuc->id)}}" ><button class="btn btn-warning">Sửa</button></a>
                        <a href="{{url('qtv/buu-cuc/delete/'.$buucuc->id)}}" ><button class="btn btn-danger">Xóa</button></a>
                    </td>
                </tr>
            @endforeach
