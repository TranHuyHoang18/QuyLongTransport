    ...
    <div id="new-category" style="display: none">
        <div class="uk-card uk-card-default">
            <div class="uk-card-body uk-padding-small uk-box-shadow" style="padding-top: 2%;padding-bottom: 5%">
                <form action="{{url('/qtv/danh-muc/tuyen-dung/store/')}}" method="post" class="uk-grid-small uk-grid" uk-grid>
                    @csrf
                ...
                <div>
                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                        <div class="uk-width-expand">
                            <span class="cardBox__header__txt uk-text-uppercase uk-text-large" style="font-size: large">Danh mục trang tuyển dụng </span>
                        </div>
                    </div>
                </div>
                ...
                <table class="cardBox__body__table uk-table uk-table-striped uk-table-hover uk-table-small">
                    ...
                    @foreach($categories as $category)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('qtv/danh-muc/tuyen-dung/edit/'.$category->id)}}" ><button class="btn btn-success">Sửa</button></a>
                                <a href="{{url('qtv/danh-muc/tuyen-dung/delete/'.$category->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa ? ')"><button class="btn btn-danger">Xóa</button></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
