                ...
                <div>
                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                        <div class="uk-width-expand">
                            <span class="cardBox__header__txt uk-text-uppercase uk-text-large" style="font-size: large">Danh mục trang giá cước</span>
                        </div>
                    </div>
                </div>
                ...
                <table class="cardBox__body__table uk-table uk-table-striped uk-table-hover uk-table-small">
                    ...
                    @foreach($categories as $category)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('qtv/danh-muc/gia-cuoc/edit/'.$category["id"])}}" ><button class="btn btn-success">Sửa</button></a>
