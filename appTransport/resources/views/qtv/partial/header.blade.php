<div class="row " style="height:60px;background:#FBB03B ">
    ...
    <div class="col-sm-3" style="height: 100%">
        <div class="row topk">
            <ul>
                @if(Auth::user()==NULL)
                    <a href="{{url('qtv/cai-dat')}}"><li><i class="fa fa-cog" aria-hidden="true" style="font-size: 30px;color: white"></i></li></a>
                    @if (Route::has('qtv.login'))
                        <a href="{{url('qtv/login') }}"><li style="color:white">Đăng nhập</li></a>
                    @endif
                @else
                    <li><i class="fa fa-user-o userhead" aria-hidden="true" style="font-size: 30px;color: white"></i></li>
                    <a href="{{url('qtv/cai-dat')}}"><li><i class="fa fa-cog" aria-hidden="true" style="font-size: 30px;color: white"></i></li></a>
                    <a href="{{ url('qtv/logout') }}"><li style="color:white">Đăng Xuất</li></a>
                @endauth
            </ul>
