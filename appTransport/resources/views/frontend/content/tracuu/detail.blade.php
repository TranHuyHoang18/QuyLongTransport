    ...
    <div class="goicuoc">
        <div class="uk-section uk-background-center-center uk-background-cover">
            <div class="uk-card-hover" style="width:90%;margin-left:5%;margin-top: 1%;background: white;border-radius: 5px;box-shadow: 5px 5px #707070;padding-bottom:2%;padding-top: 2%;padding-left: 20px;padding-right: 20px">
                ...
                <div class="home__title uk-text-bold uk-text-left uk-text-large">
                    <h4 style="color:#707070 "><span style="font-weight:bold ">{{$content['gui']}}</span> đến <span style="font-weight:bold ">{{$content['nhan']}}</span> ({{$content['khoiluong'].'kg'}})</h4>
                </div>
                <div>
                    <table class="uk-table uk-table-striped uk-table-justify uk-table-middle uk-table-responsive">
                        ...
                        @foreach($ketquas as $ketqua)
                            ...
                            <tr>
                                <td>
                                    @if($ketqua['loaidichvu']=='CPN')
                                        <img src="{{asset('images/front/icon/cpn.png')}}" style="width: 40px;float: left;margin-right: 5px;margin-top: 5px" uk-img>
                                        <h4 style="color:#707070">{{'CHUYỂN PHÁT NHANH'}}</h4>
                                    @elseif($ketqua['loaidichvu']=='VCN')
                                        <img src="{{asset('images/front/icon/vcn.png')}}" style="width: 40px;float: left;margin-right: 5px;margin-top: 5px" uk-img>
                                        <h4 style="color:#707070">{{'VẬN CHUYỂN NHANH'}}</h4>
                                    @else
                                        <img src="{{asset('images/front/icon/vtk.png')}}" style="width: 40px;float: left;margin-right: 5px;margin-top: 5px" uk-img>
                                        <h4 style="color:#707070">{{'VẬN CHUYỂN TIẾT KIỆM'}}</h4>
                                    @endif
                                    <div class="row" style="margin-left: 60px;margin-top: 2px">
                                ...
                                <td>
                                    <hr style="border-top:10px solid #E6E6E6; width: 100px;z-index: 1;position: absolute">
                                    @if($ketqua['timevc'] == "18-24h")
                                        <hr style="border-top:10px solid #53BF89; width: 15px;z-index: 2;float: left;margin-left: 20px;position: absolute">
                                    @elseif($ketqua['timevc'] == "24-32h")
                                        <hr style="border-top:10px solid #53BF89; width: 15px;z-index: 2;float: left;margin-left: 40px;position: absolute">
                                    @else
                                        <hr style="border-top:10px solid #53BF89; width: 15px;z-index: 2;float: left;margin-left: 50px;position: absolute">
                                    @endif
                                    <h5 style="color:#707070 ;margin-top: 35px">{{$ketqua['timevc']}}</h5>
                                </td>
                                <td>
                                    @if($ketqua['hinhthucvc']=='Vp-Vp')
                                        <img src="{{asset('images/front/icon/vp.png')}}"style="width: 40px" uk-img>
                                    @else
                                        <img src="{{asset('images/front/icon/doortodoor.png')}}"style="width: 40px" uk-img>
                                    @endif
                                    <h5 style="color:#707070 ;">{{$ketqua['hinhthucvc']}}</h5>
                                </td>
                                <td>
                                    <img src="{{asset('images/front/icon/crow.png')}}" style="width: 20px;float: right;margin-top: 30px;margin-right: 20px">
                                    <h5 style="color:#707070 ;">{{number_format($ketqua['gia']).' VND'}}</h5>
                                    <h5 style="color:#707070 ;">{{number_format(($ketqua['gia'])*9/10).' VND'}}</h5>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
