        ...
        <div class="uk-container">
            <div class="uk-grid-match uk-flex-middle" uk-grid>
                <div class="uk-width-expand">
                    <div class="home__title uk-text-center uk-text-uppercase uk-margin-medium" style="margin-bottom: 5px"><span>Các dịch vụ của công ty</span></div>
                    <div class="uk-margin home__block__lienhe__desc uk-text-center" style="margin-top: 10px;color:#b8b6b6 ">
                        Tổng hợp các thông tin dich vụ của công ty,...
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div>
                            <div class="uk-card uk-card-default home__block__tintuc__card uk-card-hover" >
                                <div class="uk-cover-container">
                                    <a href="{{url('dich-vu/'.$category->slug)}}">
                                ...
                                <div class="uk-card-body uk-padding-small">
                                    ...
                                    <div class="home__block__tintuc__card__title" style="color:#727171"><i class="fa fa-eye" aria-hidden="true" style="font-weight: bold;font-size: 15px;color: #b8b6b6"></i> : {{$pages[$category->id][0]->views}}</div>
                                    ...
                                    <div class="uk-text-right"><a href="{{url('dich-vu/'.$category->slug)}}" class="home__block__tintuc__card__readMore" uk-icon="icon: chevron-right; ratio: 0.7">Xem thêm</a></div>
                                </div>
                            </div>
                        </div>
                    @endif
